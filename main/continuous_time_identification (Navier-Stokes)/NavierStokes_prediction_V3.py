...
def evaluate_models(data_path, models_paths, layers, produce_table=False, prepare_for_animations=False, prepare_for_plots=False, evaluate_models=True):
    """
    ...
    - prepare_for_plots (bool): If True, prepares the data for generating plots.
...
evaluate_models(data_path, models_paths, layers, produce_table=True, prepare_for_animations=False, prepare_for_plots=True, evaluate_models=True)
