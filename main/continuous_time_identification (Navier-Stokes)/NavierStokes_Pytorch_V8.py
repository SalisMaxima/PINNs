...
class PhysicsInformedNN(nn.Module):
    def __init__(self, layers, rho1=1.0, rho2=1.0, activation='tanh'):
...
def train_pinn(data_path, layers, rho1=1.0, rho2=1.0, epochs=200000, batch_size=5000, lr=0.001, noise_level=0.0, save_path="model.pth", track_loss=False):
    ...
    model = PhysicsInformedNN(layers, rho1=rho1, rho2=rho2).to(device)
...
if __name__ == "__main__":
    ...
    save_path = "model_Validation_curve.pth"
    rho1 = 1.0  # Set your rho1 value here
    rho2 = 1.2  # Set your rho2 value here
    train_pinn(data_path, layers, rho1=rho1, rho2=rho2, epochs=200000, batch_size=5000, lr=0.001, noise_level=0, save_path=save_path, track_loss=True)
